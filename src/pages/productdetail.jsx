...
export default function ProductDetail() {
  ...
  const handleAddToCart = () => {
    ...
    if (!selectedColor && product.colors) {
      setToast({ message: "Please select a color", type: "warning" });
      return;
    }
      ...
      <div style={styles.content}>
        ...
        <div style={styles.info}>
          ...
          <div style={styles.ratingSection}>
            <div style={styles.stars}>
              {Array.from({ length: 5 }, (_, i) => (
                <span key={i} style={{ color: i < Math.round(product.rating) ? "#FFD700" : "#ddd" }}>
                  ★
                </span>
              ))}
            </div>
          ...
          {product.colors && product.colors.length > 0 && (
            <div style={styles.selectorSection}>
              <label style={styles.label}>
                Color: {selectedColor && <span style={styles.selectedValue}>{selectedColor.name}</span>}
              </label>
          ...
          {product.sizes && product.sizes.length > 0 && (
            <div style={styles.selectorSection}>
              <div style={styles.sizeHeader}>
                <label style={styles.label}>
                  Size: {selectedSize && <span style={styles.selectedValue}>{selectedSize}</span>}
                </label>
                <button
          ...
          {product.stock > 0 ? (
            ...
            <StockNotification productName={product.name} productId={product.id} />
          )}
